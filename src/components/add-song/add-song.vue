	...
	export default{
		...
		methods:{
			...
			selectSong(song,index){
				if(index !== 0){
					//不能直接用song,因为送是一个playHistory的元素，实际是个对象，因为是从缓存中取的，具song的属性，但是并不是song的实例
...
<style lang="scss" refl="stylesheet/scss">
